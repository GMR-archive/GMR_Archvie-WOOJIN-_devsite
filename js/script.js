...
### **2. 개인정보 수집 및 저장에 대한 안내**
- 당사는 이용자의 **개인정보를 수집하거나 저장하지 않습니다.**
- 이용자가 입력하는 기업명, 직무명, 자기소개서 등은 **분석을 위해 OpenAI API로 전송되지만, 서버에 저장되지 않습니다.**
...
- OpenAI의 개인정보 처리 정책을 참고하시기 바랍니다: [OpenAI 개인정보 보호정책](https://openai.com/privacy)

---

### **4. 데이터 보안 및 보호**
- 당사는 이용자의 데이터를 저장하지 않으므로, 해킹 및 유출 등의 위험이 없습니다.
- 이용자의 입력 정보는 AI 분석 후 즉시 삭제되며, 어떠한 방식으로도 보관되지 않습니다.

---

### **5. 외부 링크 안내**
- 본 서비스는 제3자 웹사이트(예: OpenAI API)에 데이터를 전송하여 분석을 수행합니다.
- 당사는 제3자 웹사이트의 개인정보 보호 정책에 대해 책임지지 않으며, 해당 정책을 별도로 확인하시기 바랍니다.
